...
import org.jeecg.util.GitLabUtil;
...
public interface GeneratorCodeService {
     ...
     * @param oldList 旧字段名
     * @return java.util.List<java.lang.String> 包含所有更新字段的字段名
     * @Author LiKun
     */
    List<String> updateFields(String updateFieldsJsonArray, String tableName, String tablePrefix, List<String> oldList);
     ...
     * @Return: void
     */
    void addFields(List<String> fieldNames, List<Map<String,Object>> fieldInfo, String tableName);
     ...
     */
    String createTable(String tablePrefix, String tableName, List<String> nameToList, List<String> markToList, List<Integer> lengthToList, List<String> typeToList);
