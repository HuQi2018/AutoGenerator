...
public class GeneratorCodeConstant {
    ...
    public static final String MESSAGE_ERROR_TYPE_NOT_EXIST = "字段类型不存在：";
    public static final String MESSAGE_ERROR_TYPE_IS_NULL = "字段类型不能为空！";
    public static final String MESSAGE_ERROR_NAME_IS_NULL = "字段名不能为空！";
    public static final String MESSAGE_ERROR_UPDATE_JSON_IS_NULL = "更新JSON中不能包含空元素！";
    public static final String MESSAGE_ERROR_UPDATE_JSON_IS_DIFFER = "更新JSON中字段信息和所有字段信息json中对应的字段信息不一致！";
    ...
    public static final String MESSAGE_INFO_FIELD_NOT_CHANGE = "更新内容未发生任何变化！";
