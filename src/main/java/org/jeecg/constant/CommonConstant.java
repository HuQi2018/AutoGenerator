...
public interface CommonConstant {
    ...
    */
    ...
    /** sys_application 表 code 唯一键索引 */
    public static final String SQL_INDEX_UNIQ_APPLICATION_CODE = "uniq_sys_application_application_code";
    /**
     * 在线聊天 是否为默认分组
     */
     ...
     * 默认应用id
     */
    public final static String APPLICATION_ID = "DefaultApplication";
}
